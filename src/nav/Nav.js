          ...
          <ul class="navbar-nav mr-auto">
            ...
            <li  class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
               ...
               <Link to ="/explore" > <a style={{"text-align":"center","width":"100%"}} class=" btn btn-primary " href="#">Explore All</a></Link>
              </div>
            </li>
          <li>
          <form class="form-inline ml-4 my-2 my-lg-0">
            <input value={this.state.value} onChange={this.handle} class="form-control  " type="search" size="40" placeholder="What do you want to learn?" aria-label="Search"/>
            <button onClick ={()=>{alert(this.state.value + "Not  Found")}} class="btn my-2 my-sm-0" type="submit"><i className="fa fa-search">  </i></button>
          </form>
          </li>
            </ul>
            <ul className="navbar-nav">
           <li class="nav-item margin3">
              <a class="nav-link" href="#">for Enterprise</a>
            </li>
             <li class="nav-item">
             <a id="login" class="nav-link margin3" href="#">Login </a>
           </li> 
            <li class="nav-item">
            <button class=" btn join margin3" >Join for Free</button>
            </li>
